...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_pystyy_ostamaan_edullisen_lounaan_kun_saldoa_edulliseen_lounaan_verran(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_pystyy_ostamaan_maukkaan_lounaan_kun_salsoa_maukkaan_lounaan_verran(self):
